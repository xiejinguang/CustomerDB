...
import test.facade.ManufacturerFacade;
...
public class ManufacturerController implements Serializable {
    ...
    @EJB private test.facade.ManufacturerFacade ejbFacade;
    private List<Manufacturer> items = null;
    private Manufacturer created;
    private List<Manufacturer> selectedItems;
    ...
    public Manufacturer getCreated() {
        return created;
    }

    public void setCreated(Manufacturer created) {
        this.created = created;
    }

    public  List<Manufacturer> getSelectedItems() {
        return selectedItems;
    }
    
    public void setSelectedItems(List<Manufacturer> selectedItems){
    ...
    public Manufacturer prepareCreate() {
        created = new Manufacturer();
        initializeEmbeddableKey();
        return created;
    }
    public List<Manufacturer> prepareSearch(){
        this.items=null;
        return this.items;
    ...
    public List<Manufacturer> searchItems() {
        items = getFacade().findByConditions(searchCons);
        return items;
    }

    public List<Manufacturer> allItems() {
    ...
    private void persist(PersistAction persistAction, String successMessage) {
        ...
        switch (persistAction) {
            ...
            default:{
                for( Manufacturer selected : selectedItems){
                    if (selected != null) {
                        setEmbeddableKeys();
                        switch (persistAction) {
