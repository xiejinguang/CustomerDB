package test.customer.controller;

import test.customer.entity.Manufacturer;
import test.customer.controller.util.JsfUtil;
import test.customer.controller.util.JsfUtil.PersistAction;
import test.customer.ejb.ManufacturerFacade;
...
public class ManufacturerController implements Serializable {
    ...
    @EJB
    private test.customer.ejb.ManufacturerFacade ejbFacade;
